...
:unnumbered: t
:END:
Google Cloud Self-Paced Labs---GSP747
** Overview
...
1. First, you will build the website locally and deploy it to Firebase manually
   so you can gain an understanding of  the entire process.
